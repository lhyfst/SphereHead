...
@click.option('--output', help='Output path', type=str, default=None, required=False)
@click.option('--outdir', help='Output dir', type=str, required=False)
...
def generate_images(
    ...
    if output is None:
        ...
        output_mp4 = os.path.splitext(network_pkl)[0] + '.mp4'
